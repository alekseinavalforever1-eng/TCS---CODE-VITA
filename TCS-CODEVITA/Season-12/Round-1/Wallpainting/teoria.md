# Guía Teórica y Análisis: Wallpainting

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Wallpainting`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Wallpainting** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Soluciones disponibles:** `WallPainting.java`
