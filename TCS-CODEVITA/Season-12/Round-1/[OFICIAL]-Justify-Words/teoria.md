# Guía Teórica y Análisis: Justify Words

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Justify-Words`  
**Tópico Principal (DSA):** `Manipulación de Cadenas (Strings) y Algoritmos de Texto`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Justify Words** evalúa la habilidad del competidor para modelar una situación mediante **manipulación de cadenas (strings) y algoritmos de texto**.
...
- **Archivos de Enunciado / Material:** `enunciado_p1.png`
