# Guía Teórica y Análisis: Stringpuzzle

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Stringpuzzle`  
**Tópico Principal (DSA):** `Teoría de Grafos, Árboles y Algoritmos de Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Stringpuzzle** evalúa la habilidad del competidor para modelar una situación mediante **teoría de grafos, árboles y algoritmos de búsqueda**.
