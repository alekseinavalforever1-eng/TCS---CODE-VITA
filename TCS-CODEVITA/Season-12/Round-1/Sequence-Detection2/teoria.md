# Guía Teórica y Análisis: Sequence Detection2

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Sequence-Detection2`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Sequence Detection2** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
