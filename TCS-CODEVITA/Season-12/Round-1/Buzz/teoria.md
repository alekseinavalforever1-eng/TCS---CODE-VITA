# Guía Teórica y Análisis: Buzz

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Buzz`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Buzz** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
...
- **Soluciones disponibles:** `buzz.py`
