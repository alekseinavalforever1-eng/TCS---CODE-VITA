# Guía Teórica y Análisis: Plague Simulation

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Plague-Simulation`  
**Tópico Principal (DSA):** `Simulación Ad-hoc, Juegos y Modelado de Estados`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Plague Simulation** evalúa la habilidad del competidor para modelar una situación mediante **simulación ad-hoc, juegos y modelado de estados**.
...
- **Soluciones disponibles:** `plague_simulation.py`
