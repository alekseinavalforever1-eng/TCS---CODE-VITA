# Guía Teórica y Análisis: Office Rostering

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Office-Rostering`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Office Rostering** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
...
- **Soluciones disponibles:** `Office_Rostering.cpp`
