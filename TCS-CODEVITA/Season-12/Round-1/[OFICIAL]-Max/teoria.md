# Guía Teórica y Análisis: Max

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Max`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Max** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Soluciones disponibles:** `Max.cpp`
