# Guía Teórica y Análisis: Vertex

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Vertex`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Vertex** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
