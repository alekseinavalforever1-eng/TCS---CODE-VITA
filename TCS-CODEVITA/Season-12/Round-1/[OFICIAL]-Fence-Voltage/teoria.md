# Guía Teórica y Análisis: Fence Voltage

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Fence-Voltage`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Fence Voltage** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Soluciones disponibles:** `fenceVoltage.py, solution.py`
