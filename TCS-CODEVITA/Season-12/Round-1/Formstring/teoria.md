# Guía Teórica y Análisis: Formstring

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Formstring`  
**Tópico Principal (DSA):** `Manipulación de Cadenas (Strings) y Algoritmos de Texto`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Formstring** evalúa la habilidad del competidor para modelar una situación mediante **manipulación de cadenas (strings) y algoritmos de texto**.
...
- **Soluciones disponibles:** `formString.py`
