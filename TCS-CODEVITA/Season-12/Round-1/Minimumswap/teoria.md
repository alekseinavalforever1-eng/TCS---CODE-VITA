# Guía Teórica y Análisis: Minimumswap

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Minimumswap`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Minimumswap** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
...
- **Soluciones disponibles:** `MinimumSwap.java`
