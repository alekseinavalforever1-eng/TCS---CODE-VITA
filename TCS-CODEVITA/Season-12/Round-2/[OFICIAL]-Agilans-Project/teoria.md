# Guía Teórica y Análisis: Agilans Project

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Agilans-Project`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Agilans Project** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Archivos de Enunciado / Material:** `enunciado.txt, enunciado_p1.png, enunciado_p2.png`
