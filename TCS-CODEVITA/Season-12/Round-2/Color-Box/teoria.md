# Guía Teórica y Análisis: Color Box

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Color-Box`  
**Tópico Principal (DSA):** `Simulación Ad-hoc, Juegos y Modelado de Estados`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Color Box** evalúa la habilidad del competidor para modelar una situación mediante **simulación ad-hoc, juegos y modelado de estados**.
