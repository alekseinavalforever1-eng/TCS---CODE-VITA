# Guía Teórica y Análisis: Gliitch Detection

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Gliitch-Detection`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Gliitch Detection** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Archivos de Enunciado / Material:** `enunciado.txt, enunciado_p1.png, enunciado_p2.png, enunciado_p3.png, enunciado_p4.png, enunciado_p5.png`
