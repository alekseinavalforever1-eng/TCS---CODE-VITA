# Guía Teórica y Análisis: Minimum Office Hours

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Minimum-Office-Hours`  
**Tópico Principal (DSA):** `Programación Dinámica y Optimización`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Minimum Office Hours** evalúa la habilidad del competidor para modelar una situación mediante **programación dinámica y optimización**.
