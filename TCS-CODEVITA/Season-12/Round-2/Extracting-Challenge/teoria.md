# Guía Teórica y Análisis: Extracting Challenge

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Extracting-Challenge`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Extracting Challenge** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
