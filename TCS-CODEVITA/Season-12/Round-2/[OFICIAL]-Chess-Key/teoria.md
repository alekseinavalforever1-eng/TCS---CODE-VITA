# Guía Teórica y Análisis: Chess Key

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Chess-Key`  
**Tópico Principal (DSA):** `Simulación Ad-hoc, Juegos y Modelado de Estados`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Chess Key** evalúa la habilidad del competidor para modelar una situación mediante **simulación ad-hoc, juegos y modelado de estados**.
