# Guía Teórica y Análisis: Farthest Reach

**Edición / Categoría:** `Season-12`  
**Nombre del Ejercicio:** `Farthest-Reach`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Farthest Reach** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
