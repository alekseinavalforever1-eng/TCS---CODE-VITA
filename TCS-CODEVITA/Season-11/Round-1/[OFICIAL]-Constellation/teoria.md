# Guía Teórica y Análisis: Constellation

**Edición / Categoría:** `Season-11`  
**Nombre del Ejercicio:** `Constellation`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Constellation** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
