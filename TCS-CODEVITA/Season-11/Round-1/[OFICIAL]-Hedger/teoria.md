# Guía Teórica y Análisis: Hedger

**Edición / Categoría:** `Season-11`  
**Nombre del Ejercicio:** `Hedger`  
**Tópico Principal (DSA):** `Programación Dinámica y Optimización`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Hedger** evalúa la habilidad del competidor para modelar una situación mediante **programación dinámica y optimización**.
...
- **Archivos de Enunciado / Material:** `enunciado_p1.jpeg`
