# Guía Teórica y Análisis: Supermarket

**Edición / Categoría:** `Season-11`  
**Nombre del Ejercicio:** `Supermarket`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Supermarket** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
