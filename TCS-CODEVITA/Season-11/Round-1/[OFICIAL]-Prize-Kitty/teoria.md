# Guía Teórica y Análisis: Prize Kitty

**Edición / Categoría:** `Season-11`  
**Nombre del Ejercicio:** `Prize-Kitty`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Prize Kitty** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
...
- **Archivos de Enunciado / Material:** `enunciado_p1.png, enunciado_p2.png, enunciado_p3.png, enunciado_p4.png`
