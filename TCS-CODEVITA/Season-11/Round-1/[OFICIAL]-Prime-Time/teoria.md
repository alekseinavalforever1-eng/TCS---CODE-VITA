# Guía Teórica y Análisis: Prime Time

**Edición / Categoría:** `Season-11`  
**Nombre del Ejercicio:** `Prime-Time`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Prime Time** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
