# Guía Teórica y Análisis: Anagram

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Anagram`  
**Tópico Principal (DSA):** `Manipulación de Cadenas (Strings) y Algoritmos de Texto`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Anagram** evalúa la habilidad del competidor para modelar una situación mediante **manipulación de cadenas (strings) y algoritmos de texto**.
...
- **Soluciones disponibles:** `Anagram.java`
