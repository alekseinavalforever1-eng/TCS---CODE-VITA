# Guía Teórica y Análisis: Alphanumeric Palindrome

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Alphanumeric-Palindrome`  
**Tópico Principal (DSA):** `Manipulación de Cadenas (Strings) y Algoritmos de Texto`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Alphanumeric Palindrome** evalúa la habilidad del competidor para modelar una situación mediante **manipulación de cadenas (strings) y algoritmos de texto**.
...
- **Soluciones disponibles:** `Alphanumeric_Palindrome.java`
