# Guía Teórica y Análisis: Football Team

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Football-Team`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Football Team** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Soluciones disponibles:** `Football_Team.java`
