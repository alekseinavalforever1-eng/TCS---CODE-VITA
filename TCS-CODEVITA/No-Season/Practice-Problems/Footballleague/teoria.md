# Guía Teórica y Análisis: Footballleague

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Footballleague`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Footballleague** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Soluciones disponibles:** `football.py, FootballLeague.java, FootballLeague.py`
