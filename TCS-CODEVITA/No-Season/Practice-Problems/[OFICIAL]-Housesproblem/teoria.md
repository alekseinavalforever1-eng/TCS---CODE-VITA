# Guía Teórica y Análisis: Housesproblem

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Housesproblem`  
**Tópico Principal (DSA):** `Programación Dinámica y Optimización`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Housesproblem** evalúa la habilidad del competidor para modelar una situación mediante **programación dinámica y optimización**.
...
- **Soluciones disponibles:** `HousesProblem.java, HousesProblem_TharunBalaji2004.java`
