# Guía Teórica y Análisis: Uncertainsteps

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Uncertainsteps`  
**Tópico Principal (DSA):** `Programación Dinámica y Optimización`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Uncertainsteps** evalúa la habilidad del competidor para modelar una situación mediante **programación dinámica y optimización**.
