# Guía Teórica y Análisis: On A Cube

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `On-A-Cube`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **On A Cube** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Archivos de Enunciado / Material:** `enunciado.md, enunciado_cube.png, enunciado_On_A_Cube.md`
- **Soluciones disponibles:** `main.cpp, OnaCube.cpp, solution.py`
