# Guía Teórica y Análisis: Sortingboxes

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Sortingboxes`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Sortingboxes** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
...
- **Soluciones disponibles:** `SortingBoxes.java`
