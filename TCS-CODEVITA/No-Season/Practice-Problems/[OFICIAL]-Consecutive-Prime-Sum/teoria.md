# Guía Teórica y Análisis: Consecutive Prime Sum

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Consecutive-Prime-Sum`  
**Tópico Principal (DSA):** `Programación Dinámica y Optimización`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Consecutive Prime Sum** evalúa la habilidad del competidor para modelar una situación mediante **programación dinámica y optimización**.
...
- **Soluciones disponibles:** `ConsecutivePrimeSum.java, ConsecutivePrimeSum_alt1.java, solution.cpp, solution.py`
