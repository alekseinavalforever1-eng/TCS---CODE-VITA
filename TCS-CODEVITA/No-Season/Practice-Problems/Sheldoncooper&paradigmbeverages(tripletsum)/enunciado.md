# Sheldoncooper&Paradigmbeverages(Tripletsum)

## Problem Description
En este problema de TCS CodeVita titulado **Sheldoncooper&Paradigmbeverages(Tripletsum)**, se requiere procesar un conjunto de datos de entrada estructurados para calcular y retornar el resultado óptimo de acuerdo a las reglas del concurso.

El ejercicio involucra análisis y transformación de cadenas de texto, requiriendo validar patrones, evaluar frecuencias de caracteres o construir secuencias que cumplan con criterios específicos.
