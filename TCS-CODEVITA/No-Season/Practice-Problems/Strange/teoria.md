# Guía Teórica y Análisis: Strange

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Strange`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Strange** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
...
- **Soluciones disponibles:** `Strange.java`
