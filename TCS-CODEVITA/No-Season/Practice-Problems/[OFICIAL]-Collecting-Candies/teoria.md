# Guía Teórica y Análisis: Collecting Candies

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Collecting-Candies`  
**Tópico Principal (DSA):** `Manipulación de Cadenas (Strings) y Algoritmos de Texto`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Collecting Candies** evalúa la habilidad del competidor para modelar una situación mediante **manipulación de cadenas (strings) y algoritmos de texto**.
...
- **Soluciones disponibles:** `CollectingCandies.java, CollectingCandies_alt1.java, main.cpp`
