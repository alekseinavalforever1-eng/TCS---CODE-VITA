# Guía Teórica y Análisis: Getawaygala

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Getawaygala`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Getawaygala** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
...
- **Soluciones disponibles:** `GetawayGala.java`
