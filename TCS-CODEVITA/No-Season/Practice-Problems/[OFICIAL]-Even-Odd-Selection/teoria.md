# Guía Teórica y Análisis: Even Odd Selection

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Even-Odd-Selection`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Even Odd Selection** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
