# Guía Teórica y Análisis: Round Table Conference

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Round-Table-Conference`  
**Tópico Principal (DSA):** `Programación Dinámica y Optimización`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Round Table Conference** evalúa la habilidad del competidor para modelar una situación mediante **programación dinámica y optimización**.
