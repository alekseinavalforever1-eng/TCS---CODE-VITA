# Guía Teórica y Análisis: Islands

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Islands`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Islands** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
