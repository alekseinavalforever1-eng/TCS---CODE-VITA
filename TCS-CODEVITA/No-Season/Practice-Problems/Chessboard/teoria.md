# Guía Teórica y Análisis: Chessboard

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Chessboard`  
**Tópico Principal (DSA):** `Simulación Ad-hoc, Juegos y Modelado de Estados`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Chessboard** evalúa la habilidad del competidor para modelar una situación mediante **simulación ad-hoc, juegos y modelado de estados**.
