# Guía Teórica y Análisis: Basecampc

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Basecampc`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Basecampc** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
