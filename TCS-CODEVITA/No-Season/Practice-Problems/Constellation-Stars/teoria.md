# Guía Teórica y Análisis: Constellation Stars

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Constellation-Stars`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Constellation Stars** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
