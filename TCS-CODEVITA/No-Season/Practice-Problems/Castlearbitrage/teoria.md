# Guía Teórica y Análisis: Castlearbitrage

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Castlearbitrage`  
**Tópico Principal (DSA):** `Programación Dinámica y Optimización`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Castlearbitrage** evalúa la habilidad del competidor para modelar una situación mediante **programación dinámica y optimización**.
