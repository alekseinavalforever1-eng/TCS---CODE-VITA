# Guía Teórica y Análisis: Count Greater Elements

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Count-Greater-Elements`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Count Greater Elements** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
