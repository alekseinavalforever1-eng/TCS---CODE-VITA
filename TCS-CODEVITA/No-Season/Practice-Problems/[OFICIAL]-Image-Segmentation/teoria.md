# Guía Teórica y Análisis: Image Segmentation

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Image-Segmentation`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Image Segmentation** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
