...
El ejercicio **Lazystudent** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Soluciones disponibles:** `LazyStudent.cpp, solution.py`
