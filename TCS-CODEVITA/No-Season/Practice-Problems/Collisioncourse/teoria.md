# Guía Teórica y Análisis: Collisioncourse

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Collisioncourse`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Collisioncourse** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Soluciones disponibles:** `CollisionCourse.cpp`
