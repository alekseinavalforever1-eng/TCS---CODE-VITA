    ...
    public static void main(String[] args){
        ...
        while(count<2){
            ...
            for(int i=0;i<installments;i++){
                ...
                double square=Math.pow((1+rate),time*12);
                double emi=(principal*rate)/(1-(1/square));
                sum+=emi;
            }
            banks[count]=sum;
        }
