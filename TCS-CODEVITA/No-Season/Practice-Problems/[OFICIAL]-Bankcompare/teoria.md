# Guía Teórica y Análisis: Bankcompare

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Bankcompare`  
**Tópico Principal (DSA):** `Manipulación de Cadenas (Strings) y Algoritmos de Texto`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Bankcompare** evalúa la habilidad del competidor para modelar una situación mediante **manipulación de cadenas (strings) y algoritmos de texto**.
...
- **Soluciones disponibles:** `BankCompare.java, BankCompare_TharunBalaji2004.java, solution.py`
