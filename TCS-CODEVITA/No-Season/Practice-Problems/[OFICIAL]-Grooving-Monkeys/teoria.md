# Guía Teórica y Análisis: Grooving Monkeys

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Grooving-Monkeys`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Grooving Monkeys** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Soluciones disponibles:** `GroovingMonkeys.java, GroovingMonkeys_TharunBalaji2004.java, solution.c, solution.py, solution_CPQuestionBank.c, solution_CPQuestionBank_1.c`
