/*
    ...
    here represent an array  of N number of integer values. The task is to find
...
/*
    Pointer approach (best for exams) :-
    * ek index rakho jo next non-zero ki position bataye
    * loop chalao
    * jab non-zero mile → us position pe rakho
    * end me bachi jagah 0 se bhar do
*/
