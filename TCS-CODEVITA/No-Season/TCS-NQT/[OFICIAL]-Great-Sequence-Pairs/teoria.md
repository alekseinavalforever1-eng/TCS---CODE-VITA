# Guía Teórica y Análisis: Great Sequence Pairs

**Edición / Categoría:** `No-Season`  
**Nombre del Ejercicio:** `Great-Sequence-Pairs`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Great Sequence Pairs** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
