# Guía Teórica y Análisis: Problem3

**Edición / Categoría:** `Season-9`  
**Nombre del Ejercicio:** `Problem3`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Problem3** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
...
- **Soluciones disponibles:** `solution.cpp, solution.py, solution_codevita_practice_old1.py, solution_codevita_practice_old1_1.py, solution_codevita_practice_old1_2.py, solution_codevita_practice_old1_3.py`
