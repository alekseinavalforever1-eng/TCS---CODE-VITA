# Guía Teórica y Análisis: Collision Course

**Edición / Categoría:** `Season-9`  
**Nombre del Ejercicio:** `Collision-Course`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Collision Course** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
