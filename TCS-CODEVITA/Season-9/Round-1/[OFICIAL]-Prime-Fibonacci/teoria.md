# Guía Teórica y Análisis: Prime Fibonacci

**Edición / Categoría:** `Season-9`  
**Nombre del Ejercicio:** `Prime-Fibonacci`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Prime Fibonacci** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
