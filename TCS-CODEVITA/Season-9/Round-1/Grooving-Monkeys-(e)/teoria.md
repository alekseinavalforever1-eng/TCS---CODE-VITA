# Guía Teórica y Análisis: Grooving Monkeys (e)

**Edición / Categoría:** `Season-9`  
**Nombre del Ejercicio:** `Grooving-Monkeys-(e)`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Grooving Monkeys (e)** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
