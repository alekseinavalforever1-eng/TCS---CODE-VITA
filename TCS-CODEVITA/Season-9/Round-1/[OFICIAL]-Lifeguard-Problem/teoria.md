# Guía Teórica y Análisis: Lifeguard Problem

**Edición / Categoría:** `Season-9`  
**Nombre del Ejercicio:** `Lifeguard-Problem`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Lifeguard Problem** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
