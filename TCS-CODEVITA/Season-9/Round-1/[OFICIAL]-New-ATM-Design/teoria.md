...
El ejercicio **New ATM Design** evalúa la habilidad del competidor para modelar una situación mediante **programación dinámica y optimización**.
...
- **Soluciones disponibles:** `solution.cpp, solution.py, solution_j33l.py`
