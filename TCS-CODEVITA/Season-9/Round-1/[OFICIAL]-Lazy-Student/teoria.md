# Guía Teórica y Análisis: Lazy Student

**Edición / Categoría:** `Season-9`  
**Nombre del Ejercicio:** `Lazy-Student`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Lazy Student** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
