# Guía Teórica y Análisis: Petrol Pump

**Edición / Categoría:** `Season-9`  
**Nombre del Ejercicio:** `Petrol-Pump`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Petrol Pump** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
...
- **Soluciones disponibles:** `solution.cpp, solution.py, solution_codevita_practice_old1.cpp, solution_codevita_practice_old1.py, solution_codevita_practice_old1_1.py, solution_codevita_practice_old1_2.py`
