# Guía Teórica y Análisis: Swayamvar

**Edición / Categoría:** `Season-9`  
**Nombre del Ejercicio:** `Swayamvar`  
**Tópico Principal (DSA):** `Manipulación de Cadenas (Strings) y Algoritmos de Texto`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Swayamvar** evalúa la habilidad del competidor para modelar una situación mediante **manipulación de cadenas (strings) y algoritmos de texto**.
...
- **Archivos de Enunciado / Material:** `enunciado.md, enunciado_MockVita2_Swayamvar.md`
- **Soluciones disponibles:** `solution.py, solution_codevita_practice_old1.py, solution_MockVita2_Swayamvar.py`
