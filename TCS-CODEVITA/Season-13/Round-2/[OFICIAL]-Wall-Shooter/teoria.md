# Guía Teórica y Análisis: Wall Shooter

**Edición / Categoría:** `Season-13`  
**Nombre del Ejercicio:** `Wall-Shooter`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Wall Shooter** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
