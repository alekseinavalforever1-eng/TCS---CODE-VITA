# Guía Teórica y Análisis: Bubble Shooter

**Edición / Categoría:** `Season-13`  
**Nombre del Ejercicio:** `Bubble-Shooter`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Bubble Shooter** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Archivos de Enunciado / Material:** `enunciado.md, enunciado_MITHRAN_BALACHANDER.md, enunciado_MITHRAN_BALACHANDER_1.md, enunciado_MITHRAN_BALACHANDER_2.md`
- **Soluciones disponibles:** `solution.java, solution.py`
