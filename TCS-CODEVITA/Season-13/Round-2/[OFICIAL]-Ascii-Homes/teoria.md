# Guía Teórica y Análisis: Ascii Homes

**Edición / Categoría:** `Season-13`  
**Nombre del Ejercicio:** `Ascii-Homes`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Ascii Homes** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
...
- **Archivos de Enunciado / Material:** `enunciado.md, solution_notes.md, test_input.txt`
