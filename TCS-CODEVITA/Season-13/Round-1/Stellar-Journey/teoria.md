# Guía Teórica y Análisis: Stellar Journey

**Edición / Categoría:** `Season-13`  
**Nombre del Ejercicio:** `Stellar-Journey`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Stellar Journey** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
...
- **Archivos de Enunciado / Material:** `enunciado.md, test_stellar1.txt, test_stellar2.txt, test_stellar3.txt`
- **Soluciones disponibles:** `solution.java, solution.py, solution_Bil_2.py`
