# Guía Teórica y Análisis: Order It

**Edición / Categoría:** `Season-13`  
**Nombre del Ejercicio:** `Order-It`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Order It** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
