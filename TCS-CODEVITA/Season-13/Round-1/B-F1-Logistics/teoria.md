# Guía Teórica y Análisis: B F1 Logistics

**Edición / Categoría:** `Season-13`  
**Nombre del Ejercicio:** `B-F1-Logistics`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **B F1 Logistics** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
