# Guía Teórica y Análisis: Two Scouts

**Edición / Categoría:** `Season-13`  
**Nombre del Ejercicio:** `Two-Scouts`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Two Scouts** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
