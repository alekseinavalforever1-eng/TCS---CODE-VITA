# Guía Teórica y Análisis: Gravity Game

**Edición / Categoría:** `Season-13`  
**Nombre del Ejercicio:** `Gravity-Game`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Gravity Game** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
