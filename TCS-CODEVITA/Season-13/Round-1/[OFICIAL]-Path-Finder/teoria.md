# Guía Teórica y Análisis: Path Finder

**Edición / Categoría:** `Season-13`  
**Nombre del Ejercicio:** `Path-Finder`  
**Tópico Principal (DSA):** `Programación Dinámica y Optimización`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Path Finder** evalúa la habilidad del competidor para modelar una situación mediante **programación dinámica y optimización**.
