# Guía Teórica y Análisis: Sai Mini Project

**Edición / Categoría:** `Season-13`  
**Nombre del Ejercicio:** `Sai-Mini-Project`  
**Tópico Principal (DSA):** `Manipulación de Cadenas (Strings) y Algoritmos de Texto`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Sai Mini Project** evalúa la habilidad del competidor para modelar una situación mediante **manipulación de cadenas (strings) y algoritmos de texto**.
...
- **Archivos de Enunciado / Material:** `enunciado.md, enunciado_images.md`
- **Soluciones disponibles:** `SaiMiniProject.java, solution.cpp`
