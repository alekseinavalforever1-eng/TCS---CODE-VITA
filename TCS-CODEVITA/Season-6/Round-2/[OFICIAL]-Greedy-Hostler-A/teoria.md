# Guía Teórica y Análisis: Greedy Hostler A

**Edición / Categoría:** `Season-6`  
**Nombre del Ejercicio:** `Greedy-Hostler-A`  
**Tópico Principal (DSA):** `Algoritmos Voraces (Greedy) y Programación de Intervalos`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Greedy Hostler A** evalúa la habilidad del competidor para modelar una situación mediante **algoritmos voraces (greedy) y programación de intervalos**.
