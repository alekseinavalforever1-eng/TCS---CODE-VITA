# Guía Teórica y Análisis: Counting Rectangle

**Edición / Categoría:** `Season-6`  
**Nombre del Ejercicio:** `Counting-Rectangle`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Counting Rectangle** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
