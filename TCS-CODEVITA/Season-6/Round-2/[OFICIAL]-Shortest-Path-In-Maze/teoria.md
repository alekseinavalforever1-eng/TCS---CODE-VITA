# Guía Teórica y Análisis: Shortest Path In Maze

**Edición / Categoría:** `Season-6`  
**Nombre del Ejercicio:** `Shortest-Path-In-Maze`  
**Tópico Principal (DSA):** `Teoría de Grafos, Árboles y Algoritmos de Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Shortest Path In Maze** evalúa la habilidad del competidor para modelar una situación mediante **teoría de grafos, árboles y algoritmos de búsqueda**.
