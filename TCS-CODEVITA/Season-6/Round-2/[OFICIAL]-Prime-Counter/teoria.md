# Guía Teórica y Análisis: Prime Counter

**Edición / Categoría:** `Season-6`  
**Nombre del Ejercicio:** `Prime-Counter`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Prime Counter** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
