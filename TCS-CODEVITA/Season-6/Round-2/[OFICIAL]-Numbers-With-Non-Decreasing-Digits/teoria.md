# Guía Teórica y Análisis: Numbers With Non Decreasing Digits

**Edición / Categoría:** `Season-6`  
**Nombre del Ejercicio:** `Numbers-With-Non-Decreasing-Digits`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Numbers With Non Decreasing Digits** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
...
- **Archivos de Enunciado / Material:** `enunciado.pdf`
