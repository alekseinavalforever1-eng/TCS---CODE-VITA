# Guía Teórica y Análisis: Counting Rectangles

**Edición / Categoría:** `Season-6`  
**Nombre del Ejercicio:** `Counting-Rectangles`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Counting Rectangles** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
