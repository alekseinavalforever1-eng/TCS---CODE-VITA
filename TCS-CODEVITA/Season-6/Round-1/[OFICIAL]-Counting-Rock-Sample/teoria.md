# Guía Teórica y Análisis: Counting Rock Sample

**Edición / Categoría:** `Season-6`  
**Nombre del Ejercicio:** `Counting-Rock-Sample`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Counting Rock Sample** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
