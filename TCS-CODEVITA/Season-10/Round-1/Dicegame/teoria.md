# Guía Teórica y Análisis: Dicegame

**Edición / Categoría:** `Season-10`  
**Nombre del Ejercicio:** `Dicegame`  
**Tópico Principal (DSA):** `Simulación Ad-hoc, Juegos y Modelado de Estados`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Dicegame** evalúa la habilidad del competidor para modelar una situación mediante **simulación ad-hoc, juegos y modelado de estados**.
