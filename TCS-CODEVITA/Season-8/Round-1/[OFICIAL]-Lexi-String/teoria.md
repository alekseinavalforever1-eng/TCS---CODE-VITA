# Guía Teórica y Análisis: Lexi String

**Edición / Categoría:** `Season-8`  
**Nombre del Ejercicio:** `Lexi-String`  
**Tópico Principal (DSA):** `Manipulación de Cadenas (Strings) y Algoritmos de Texto`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Lexi String** evalúa la habilidad del competidor para modelar una situación mediante **manipulación de cadenas (strings) y algoritmos de texto**.
