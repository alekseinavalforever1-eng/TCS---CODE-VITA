# Guía Teórica y Análisis: New Atm Design

**Edición / Categoría:** `Season-8`  
**Nombre del Ejercicio:** `New-Atm-Design`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **New Atm Design** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
