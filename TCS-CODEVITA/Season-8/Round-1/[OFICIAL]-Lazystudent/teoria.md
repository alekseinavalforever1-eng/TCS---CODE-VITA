# Guía Teórica y Análisis: Lazystudent

**Edición / Categoría:** `Season-8`  
**Nombre del Ejercicio:** `Lazystudent`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Lazystudent** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
