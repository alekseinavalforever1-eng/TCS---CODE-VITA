# Guía Teórica y Análisis: Marathon Winner

**Edición / Categoría:** `Season-8`  
**Nombre del Ejercicio:** `Marathon-Winner`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Marathon Winner** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
