# Guía Teórica y Análisis: Friendcircle

**Edición / Categoría:** `Season-8`  
**Nombre del Ejercicio:** `Friendcircle`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Friendcircle** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
