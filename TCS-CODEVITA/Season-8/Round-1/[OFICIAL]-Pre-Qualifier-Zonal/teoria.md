# Guía Teórica y Análisis: Pre Qualifier Zonal

**Edición / Categoría:** `Season-8`  
**Nombre del Ejercicio:** `Pre-Qualifier-Zonal`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Pre Qualifier Zonal** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
...
- **Archivos de Enunciado / Material:** `enunciado_questions.pdf`
