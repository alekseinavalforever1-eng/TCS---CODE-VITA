# Guía Teórica y Análisis: Bad Permutation

**Edición / Categoría:** `Season-8`  
**Nombre del Ejercicio:** `Bad-Permutation`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Bad Permutation** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
...
- **Archivos de Enunciado / Material:** `enunciado_screencapture.pdf`
