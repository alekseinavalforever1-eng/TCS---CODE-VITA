# Guía Teórica y Análisis: Bank Statement

**Edición / Categoría:** `Season-8`  
**Nombre del Ejercicio:** `Bank-Statement`  
**Tópico Principal (DSA):** `Estructuras de Datos: Arrays, Matrices y Búsqueda`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Bank Statement** evalúa la habilidad del competidor para modelar una situación mediante **estructuras de datos: arrays, matrices y búsqueda**.
