# Guía Teórica y Análisis: Overlapping Boxes

**Edición / Categoría:** `Season-8`  
**Nombre del Ejercicio:** `Overlapping-Boxes`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Overlapping Boxes** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
