# Guía Teórica y Análisis: Colliding Canons

**Edición / Categoría:** `Season-7`  
**Nombre del Ejercicio:** `Colliding-Canons`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Colliding Canons** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
