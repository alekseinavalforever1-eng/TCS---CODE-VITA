# Guía Teórica y Análisis: Colliding Cannon

**Edición / Categoría:** `Season-7`  
**Nombre del Ejercicio:** `Colliding-Cannon`  
**Tópico Principal (DSA):** `Geometría Computacional y Álgebra Vectorial`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Colliding Cannon** evalúa la habilidad del competidor para modelar una situación mediante **geometría computacional y álgebra vectorial**.
