# Guía Teórica y Análisis: Bank Compare

**Edición / Categoría:** `Season-7`  
**Nombre del Ejercicio:** `Bank-Compare`  
**Tópico Principal (DSA):** `Matemáticas Discretas, Aritmética Modular y Teoría de Números`  

---

## 1. Concepto y Enfoque del Problema
El ejercicio **Bank Compare** evalúa la habilidad del competidor para modelar una situación mediante **matemáticas discretas, aritmética modular y teoría de números**.
